...
enum {
	...
	Uart_C5_TDMAS_Shift = 7,
	Uart_C5_TDMAS_Mask = 1 << Uart_C5_TDMAS_Shift,

	Uart_C5_RDMAS_Shift = 5,
	Uart_C5_RDMAS_Mask = 1 << Uart_C5_RDMAS_Shift,

	Uart_MODEM_TXRTSPOL_Shift = 2,
	Uart_MODEM_TXRTSPOL_Mask = 1 << Uart_MODEM_TXRTSPOL_Shift,
	Uart_MODEM_TXRTSPOL_ACTLOW = 0 << Uart_MODEM_TXRTSPOL_Shift,
	Uart_MODEM_TXRTSPOL_ACTHIGH = 1 << Uart_MODEM_TXRTSPOL_Shift,

	Uart_MODEM_TXRTSE_Shift = 1,
	Uart_MODEM_TXRTSE_Mask = 1 << Uart_MODEM_TXRTSE_Shift,
...
volatile UART_Type * const volatile hw_uart1 = (UART_Type *) Memmap_UART1_Addr;

volatile UART_Type * const volatile hw_uart2 = (UART_Type *) Memmap_UART2_Addr;

volatile UART_Type * const volatile hw_uart3 = (UART_Type *) Memmap_UART3_Addr;

volatile UART_Type * const volatile hw_uart4 = (UART_Type *) Memmap_UART4_Addr;

volatile UART_Type * const volatile hw_uart5 = (UART_Type *) Memmap_UART5_Addr;
