...
enum {
	...
	Scb_ICSR_PENDSVSET_Shift = 28,
	Scb_ICSR_PENDSVSET_Mask = 1 <<Scb_ICSR_PENDSVSET_Shift ,

	Scb_ICSR_PENDSVCLR_Shift = 27,
	Scb_ICSR_PENDSVCLR_Mask = 1 <<Scb_ICSR_PENDSVCLR_Shift ,
} scb_fields_t;
