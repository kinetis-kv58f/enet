...
enum {
	...
	DMAMUX_CHCFG_SOURCE_Group0_Uart1Rx = 4,
	DMAMUX_CHCFG_SOURCE_Group0_Uart1Tx = 5,
...
enum {
	...
	EDMA_TCD_BITER_ELINK_Shift = 15,
	EDMA_TCD_BITER_ELINK_Mask = 1 << EDMA_TCD_BITER_ELINK_Shift,
	EDMA_TCD_BITER_LINKCH_Shift = 9,
	EDMA_TCD_BITER_LINKCH_Mask = 0x1F << EDMA_TCD_BITER_LINKCH_Shift,

	EDMA_TCD_CITER_ELINK_Shift = 15,
	EDMA_TCD_CITER_ELINK_Mask = 1 << EDMA_TCD_CITER_ELINK_Shift,
	EDMA_TCD_CITER_LINKCH_Shift = 9,
	EDMA_TCD_CITER_LINKCH_Mask = 0x1F << EDMA_TCD_CITER_LINKCH_Shift,
