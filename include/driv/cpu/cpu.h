...
enum {
	...
	System_CoreCLK_Freq = 237500000,

	System_FastPhCLK_Freq = 118750000,

	System_FlexbusCLK_Freq = 59375000,

	System_BusFlashCLK_Freq = 29687500,
};
...
extern void cpu_trigger_pendsv(void);
